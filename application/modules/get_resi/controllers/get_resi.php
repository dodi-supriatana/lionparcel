...
class get_resi extends MX_Controller
{
    ...
    public function generate()
    {
        ...
        $dataImage['product'] = $book_detail->product;
        $dataImage['date'] = $date;
        $dataImage['nama_agen'] = $book_detail->nama_agen;
        $dataImage['alamat_agen'] = $book_detail->alamat_agen;
        $dataImage['nama_penerima'] = $book_detail->receiver;
        $dataImage['alamat_penerima'] = $book_detail->destination;
        $dataImage['nomor_penerima'] = $book_detail->nomor_penerima;
        $dataImage['nama_pengirim'] = $book_detail->sender;
        $dataImage['alamat_pengirim'] = $book_detail->origin;
        $dataImage['nomor_pengirim'] = $book_detail->nomor_pengirim;
        $dataImage['panjang'] = $book_detail->dimensi_panjang;
        $dataImage['lebar'] = $book_detail->dimensi_lebar;
        $dataImage['tinggi'] = $book_detail->dimensi_tinggi;
        $dataImage['berat'] = $book_detail->berat;
        $dataImage['harga'] = $book_detail->harga;
