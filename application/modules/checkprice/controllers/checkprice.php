...
class checkprice extends MX_Controller
{
    ...
    public function get_checkprice()
    {
        ...
        $competitor=$this->db->query("SELECT * FROM competitor WHERE origin_3lc='".$origin."' and destination_3lc='".$destinance."' and price !='' ORDER BY  cmpany desc ,price desc")->result();
        $this->djson(
			array(
				"status"=>"200",
                "data"=>$data,
